...
?> 
    ...
    <center>
        <div class="panel panel-default">
            <div class="panel-heading"><i class="fa fa-info-circle fa-fw"></i><b>Status da Conta do Cliente</b></div>
                ...
                <div class="container-fluid">
                    <div class="card" style="width: 18rem;">
                        <?php
                            ...
                            $consulta=$conexao->query("SELECT*FROM statusUsuario WHERE codigo = $codigo;");
