...
function editar(){
    ...
    $sql = "UPDATE tipoUsuario SET descricao = '".$dados['descricao']."' WHERE codigo = '".$dados['codigo']."';";
...
function salvar(){
    ...
    $sql = "INSERT INTO tipoUsuario (codigo, descricao) VALUES ('".$dados['codigo']."','".$dados['descricao']."')";
